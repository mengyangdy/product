  ...
  <div class="item-desc ml1r mb1r">
    <div class="content" v-if="!props.isMy">
      <div class="location-wrapper" v-if="item.city || item.address">
        <div class="location">
          <img src="../../assets/img/icon/location.webp
" alt="">
          <span>{{item.city}}</span>
      ...
      <div class="live" v-if="props.isLive">
        直播中
      </div>
      ...
      <div class="comment">
        <div class="type-comment">
          ...
          <div class="right">
            <p>
              ...
              <span class="time">2020-02-01</span>
            </p>
            <p class="text">北京</p>
          </div>
        </div>
        <transition-group name="comment-status" tag="div" class="loveds">
          <div class="type-loved" :key="i" v-for="i in state.test">
            <img src="../../assets/img/icon/head-image.jpeg" class="avatar" alt="">
